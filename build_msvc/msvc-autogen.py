...
libs = [
    'libpatentcoin_cli',
    'libpatentcoin_common',
    'libpatentcoin_crypto',
    'libpatentcoin_server',
    'libpatentcoin_util',
    'libpatentcoin_wallet_tool',
    'libpatentcoin_wallet',
    'libpatentcoin_zmq',
    'bench_patentcoin',
    'libtest_util',
]
...
def main():
    parser = argparse.ArgumentParser(description='Patentcoin-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/patentcoin_config.h'), os.path.join(SOURCE_DIR, 'config/patentcoin-config.h'))
