...
// patentcoin includes.
#include <..\src\script\patentcoinconsensus.h>
...
int main()
{
    std::cout << "patentcoinconsensus version: " << patentcoinconsensus_version() << std::endl;
    ...
    auto op0Result = patentcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, patentcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
