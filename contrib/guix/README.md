# Bootstrappable Patentcoin Core Builds

This directory contains the files necessary to perform bootstrappable Patentcoin
Core builds.
...
- 24GB of free disk space on the partition that the Patentcoin Core git repository
  resides in
...
For a Patentcoin Core depends development environment, simply invoke
...
From the top of a clean Patentcoin Core repository:
...
To use dongcarl's substitute server for Patentcoin Core builds after having
