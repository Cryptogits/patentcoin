...
Arguments:
    <base_directory> - The base directory of a patentcoin source code repository.
...
Arguments:
    <file> - A source file in the patentcoin repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Patentcoin
