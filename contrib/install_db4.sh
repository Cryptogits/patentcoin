...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the patentcoin repository."
  exit 1
fi
...
# See https://github.com/patentcoin/patentcoin/issues/16064
...
echo 'When compiling patentcoind, run `./configure` in the following way:'
echo
