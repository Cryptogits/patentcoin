Contributing to Patentcoin Core
============================

The Patentcoin Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/patentcoin/patentcoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or participate in a weekly [Patentcoin Core PR Review Club](https://patentcoincore.reviews/) meeting.

Communication Channels
----------------------

Most communication about Bitcoin Core development happens on IRC, in the
#patentcoin-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/patentcoin-core-dev/](http://www.erisian.com.au/patentcoin-core-dev/)
and [http://gnusha.org/patentcoin-core-dev/](http://gnusha.org/patentcoin-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/patentcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to patentcoin-qt
...
[Translation Process](https://github.com/patentcoin/patentcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Patentcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Patentcoin
Network Protocol consensus changes.

Whether a pull request is merged into Patentcoin Core rests with the project merge
...
Patches that change Patentcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Patentcoin consensus, it must have been
...
https://github.com/patentcoin/patentcoin/pull/16189).

Also see the [backport.py script](
https://github.com/patentcoin-core/patentcoin-maintainer-tools#backport).

Release Policy
--------------

The project leader is the release manager for each Patentcoin Core release.
