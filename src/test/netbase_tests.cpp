...
{
    BOOST_CHECK(TestSplitHost("www.patentcoincore.org", "www.patentcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.patentcoincore.org]", "www.patentcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.patentcoincore.org:80", "www.patentcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.patentcoincore.org]:80", "www.patentcoincore.org", 80));
