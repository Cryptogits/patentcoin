...
#ifndef PATENTCOIN_TEST_SCRIPTNUM10_H
#define PATENTCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Patentcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // PATENTCOIN_TEST_BIGNUM_H
