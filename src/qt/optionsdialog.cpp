    ...
    mapper(nullptr)
{
    ...
    ui->patentcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->patentcoinAtStartup);
    ...
    ui->patentcoinAtStartup->setToolTip(ui->patentcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->patentcoinAtStartup->setText(ui->patentcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openPatentcoinConfButton->setToolTip(ui->openPatentcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new PatentcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->patentcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openPatentcoinConfButton_clicked()
{
