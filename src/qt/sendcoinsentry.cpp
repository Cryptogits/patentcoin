    ...
    platformStyle(_platformStyle)
{
    ...
    // normal patentcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying patentcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &PatentcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
