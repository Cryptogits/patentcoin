...
#ifndef PATENTCOIN_COMPAT_ASSUMPTIONS_H
#define PATENTCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Patentcoin cannot be compiled without assertions."
#endif
...
#endif // PATENTCOIN_COMPAT_ASSUMPTIONS_H
