...
#ifndef PATENTCOIN_WALLET_WALLETUTIL_H
#define PATENTCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! patentcoin from opening the wallet, thinking it was newly created, and
...
#endif // PATENTCOIN_WALLET_WALLETUTIL_H
