...
#ifndef PATENTCOIN_WALLET_WALLET_H
#define PATENTCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this patentcoin node, and set to 0 for transactions that were created
...
#endif // PATENTCOIN_WALLET_WALLET_H
