...
#ifndef PATENTCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define PATENTCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Patentcoin Core wallet was originally a collection of unrelated private
...
#endif // PATENTCOIN_WALLET_SCRIPTPUBKEYMAN_H
