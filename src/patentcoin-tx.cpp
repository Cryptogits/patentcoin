...
static void SetupPatentcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " patentcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  patentcoin-tx [options] <hex-tx> [commands]  Update hex-encoded patentcoin transaction\n" +
            "or:     patentcoin-tx [options] -create [commands]   Create hex-encoded patentcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded patentcoin transaction
