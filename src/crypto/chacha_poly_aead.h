...
#ifndef PATENTCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define PATENTCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@patentcoin.
 *
 ...
 *
 * The chacha20-poly1305@patentcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@patentcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@patentcoin are relatively fast in
...
#endif // PATENTCOIN_CRYPTO_CHACHA_POLY_AEAD_H
