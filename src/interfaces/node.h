...
#ifndef PATENTCOIN_INTERFACES_NODE_H
#define PATENTCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a patentcoin node (patentcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // PATENTCOIN_INTERFACES_NODE_H
