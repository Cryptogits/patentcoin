...
#ifndef PATENTCOIN_UTIL_MESSAGE_H
#define PATENTCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's patentcoin address, it must refer to a public key.
...
#endif // PATENTCOIN_UTIL_MESSAGE_H
