...
class TestShell:
    """Wrapper Class for PatentcoinTestFramework.

    The TestShell class extends the PatentcoinTestFramework
    ...
    class __TestShell(PatentcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by PatentcoinTestFramework child class.
            self.num_nodes = 1
