...
"""Verify that starting patentcoin with -h works as expected."""

from test_framework.test_framework import PatentcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(PatentcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start patentcoin with -h for help text")
        ...
        self.log.info("Start patentcoin with -version for version information")
        ...
        self.log.info("Start patentcoind with -fakearg to make sure it does not start")
