...
# TestP2PConn: A peer we use to send messages to patentcoind, and store responses.
...
class CompactBlocksTest(PatentcoinTestFramework):
    ...
    # This test actually causes patentcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that patentcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for patentcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # patentcoind will not send blocktxn responses for blocks whose height is
