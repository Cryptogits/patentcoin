...
class P2PPermissionsTests(PatentcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].patentcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].patentcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
