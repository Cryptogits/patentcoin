...
from test_framework.util import (
    adjust_patentcoin_conf_for_pre_17,
    assert_equal,
    sync_blocks,
    sync_mempools,
)
...
class BackwardsCompatibilityTest(PatentcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # adapt patentcoin.conf, because older patentcoind's don't recognize config sections
        adjust_patentcoin_conf_for_pre_17(self.nodes[5].patentcoinconf)
    ...
    def run_test(self):
        ...
        # RPC loadwallet failure causes patentcoind to exit, in addition to the RPC
        # call failure, so the following test won't work:
        # assert_raises_rpc_error(-4, "Wallet loading failed.", node_v17.loadwallet, 'w3_v18')

        # Instead, we stop node and try to launch it with the wallet:
        self.stop_node(4)
        node_v17.assert_start_raises_init_error(["-wallet=w3_v18"], "Error: Error loading w3_v18: Wallet requires newer version of Patentcoin Core")
        node_v17.assert_start_raises_init_error(["-wallet=w3"], "Error: Error loading w3: Wallet requires newer version of Patentcoin Core")
        self.start_node(4)
        ...
        # Copy the 0.17 wallet to the last Patentcoin Core version and open it:
        ...
        # Copy the 0.19 wallet to the last Patentcoin Core version and open it:
        shutil.copytree(
