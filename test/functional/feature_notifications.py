...
class NotificationsTest(PatentcoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            ...
            # https://github.com/patentcoin/patentcoin/pull/9371, it might be better
            ...
            # https://github.com/patentcoin/patentcoin/pull/16624. The bug is reported
            # in issue https://github.com/patentcoin/patentcoin/issues/18325.
