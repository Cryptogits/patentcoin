...
By default, patentcoind will dump mempool on shutdown and
...
class MempoolPersistTest(PatentcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent patentcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
