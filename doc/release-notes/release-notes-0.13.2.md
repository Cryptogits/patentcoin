Patentcoin Core version 0.13.2 is now available from:

  <https://patentcoin.org/bin/patentcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update patentcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow patentcoin-tx to create v2 transactions (btcdrak)
