Patentcoin Core version *0.15.2* is now available from:

  <https://patentcoincore.org/bin/patentcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in patentcoin-tx (TheBlueMatt)
