Patentcoin Core version 0.16.1 is now available from:

  <https://patentcoincore.org/bin/patentcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting patentcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure patentcoind processes are cleaned up when tests end (sdaftuar)
