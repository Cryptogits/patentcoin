Patentcoin Core version 0.9.4 is now available from:

  https://patentcoin.org/bin/0.9.4/
...
this update is incompatible with the Patentcoin system and could lead to consensus
forks.

Patentcoin Core released binaries from https://patentcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~patentcoin/+archive/ubuntu/patentcoin
- A third-party or self-compiled Patentcoin Core

upgrade to Patentcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
