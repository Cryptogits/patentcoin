Patentcoin Core version *0.15.0.1* is now available from:

  <https://patentcoin.org/bin/patentcoin-core-0.15.0.1/>

and

  <https://patentcoincore.org/bin/patentcoin-core-0.15.0.1/>
