Patentcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/patentcoin/files/Patentcoin/patentcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Patentcoin
...
New/changed settings (command-line or patentcoin.conf file)
--------------------------------------------------------
