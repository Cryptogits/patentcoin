Patentcoin Core version 0.9.2.1 is now available from:

  https://patentcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 PC to 0.01 PC
...
- Fix "Start patentcoin on system login"
