...
Patentcoin Core version 0.19.1 is now available from:

  <https://patentcoincore.org/bin/patentcoin-core-0.19.1/>
...
From Patentcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Patentcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Patentcoin Core does not yet change appearance when
...
- #17488 fix "patentcoind already running" warnings on macOS (fanquake)
...
[Transifex](https://www.transifex.com/patentcoin/patentcoin/).
