Patentcoin Core version 0.10.4 is now available from:

  <https://patentcoin.org/bin/patentcoin-core-0.10.4/>
...
- #6953 `43c2789` Split patentcoin-tx into its own package
- #6953 `dfe0d4d` Include patentcoin-tx binary on Debian/Ubuntu
