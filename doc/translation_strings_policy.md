...
This document provides guidelines for internationalization of the Patentcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `patentcoin_en.ts` remains unchanged.
